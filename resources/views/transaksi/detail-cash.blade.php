    ...
    <div class="form-group row">
                <div class="col form-inline">
                   ...
                   @if ($transaksi->status !='diambil')
                        <button class="btn btn-success dropdown-toggle" type="button" data-toggle="dropdown">Pilih Status Menjadi</button>
                        @endif
                        <div class="dropdown-menu">
                            ...
                            <a href="{{ route('transaksi.status',[
                                'transaksi' => $transaksi->id,
                                'status'=> $row[1]
                            ]) }}" class="dropdown-item"> {{ $row[0] }}</a>
                            @endforeach
                        </div>
                   </div>
                </div>
